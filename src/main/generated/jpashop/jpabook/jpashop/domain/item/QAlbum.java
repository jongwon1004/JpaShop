...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = -1240124870L;
    ...
    //inherited
    public final ListPath<jpashop.jpabook.jpashop.domain.Category, jpashop.jpabook.jpashop.domain.QCategory> categories = _super.categories;
